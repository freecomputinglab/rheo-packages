...
- `@idea:etal` — the terse form, but on its own it renders as a bare figure
  ...
  ```typst
  #import "@rheo/rookery:0.4.0": idea, window, link-to-page
  ...
  **Where it links:** `link-to-page` (above) goes to the note's own minted
  ...
  ```typst
  #import "@rheo/rookery:0.4.0": idea, window, link-to-anchor
...
```typst
#import "@rheo/rookery:0.4.0": idea-body
...
`rookery/0.4.0/demo/rheo/content/lib.typ` carries the two-line version.
