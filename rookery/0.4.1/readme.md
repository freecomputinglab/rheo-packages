...
```typst
#import "@rheo/rookery:0.4.1": rookery, idea, window
#show: rookery.with(
...
- `@idea:etal` — the terse form, but on its own it renders as a bare figure
  ...
  ```typst
  #import "@rheo/rookery:0.4.1": idea, window, link-to-page
  ...
  **Where it links:** `link-to-page` (above) goes to the note's own minted
  ...
  ```typst
  #import "@rheo/rookery:0.4.1": idea, window, link-to-anchor
...
```typst
#import "@rheo/rookery:0.4.1": ideas-outline
#ideas-outline()
...
```typst
#import "@rheo/rookery:0.4.1": ideas, note-href
#context {
  for e in ideas() {
    [#e.name — #e.text \ ]
...
```typst
#import "@rheo/rookery:0.4.1": idea-body
...
```typst
#import "@rheo/rookery:0.4.1": idea, footnote
...
`rookery/0.4.1/demo/rheo/content/lib.typ` carries the two-line version.
