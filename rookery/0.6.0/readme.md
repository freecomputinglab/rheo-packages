...
1. **`note` and `todo` are no longer exported.** Two lines restore them
   ...
   ```typst
   #import "@rheo/rookery:0.6.0": tagged-idea
...
```typst
#import "@rheo/rookery:0.6.0": rookery, idea, window
#show: rookery.with(
...
- `@idea:etal` — the terse form, but on its own it renders as a bare figure
  ...
  ```typst
  #import "@rheo/rookery:0.6.0": idea, window, link-to-page
  ...
  **Where it links:** `link-to-page` (above) goes to the note's own minted
  ...
  ```typst
  #import "@rheo/rookery:0.6.0": idea, window, link-to-anchor
...
```typst
#import "@rheo/rookery:0.6.0": ideas-outline
#ideas-outline()
...
```typst
#import "@rheo/rookery:0.6.0": ideas, note-href
#context {
  for e in ideas() {
    [#e.name — #e.text \ ]
...
```typst
#import "@rheo/rookery:0.6.0": idea-body
...
```typst
#import "@rheo/rookery:0.6.0": idea, footnote
