...
#import "@rheo/rookery-search:0.4.1": search-bar
#show: rookery
...
- **The theme comes from rookery's `:root` rule now**, rather than being
  ...
  `@rheo/rookery:0.4.1`, which this version imports.
...
```typst
#import "@rheo/rookery-search:0.4.1": search-ideas
#context {
