...
#import "@rheo/rookery-search:0.5.0": search-bar
#show: rookery
...
- **The theme comes from rookery's `:root` rule now**, rather than being
  ...
  `@rheo/rookery:0.5.0`, which this version imports.
...
```typst
#import "@rheo/rookery-search:0.5.0": search-ideas
#context {
